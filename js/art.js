...
(function (global) {
  ...
  //   R まゆ(ロボ)  F 顔(白)  U マズル(おなか色)  Y 目  N 鼻  T しっぽ(長)  t しっぽ(短)  n たね  z zzz
  // =====================================================================
  ...
  // ねこあつめの文法: 縦 1×2 の点目、鼻を頂点にした小さな ω、輪郭の外に突き出るヒゲ、白いマズル(U=おなか色)、
  // 下ぶくれの頭 + 一回り小さい体。頭の輪郭は col 2〜21、ヒゲは col 0〜1 / 22〜23。
  const FRONT = M([
    '............',
    '.....LLL....',
    '....LEEEL...',
  ...
  const SIDE = [
    ...
    '....LBBBBBBBBBBBBBBL....',
    '...LBBBBBBBBBBBBBBBBL...',
    '..LBBBBBBBBBBBBBBYBBBL..',
    '..LBBBBBBBBBBBBBBYBBBBL.',
    '.LBBBBBBBBBBBBBBBBBUUUL.',
    '.LBPPBBBBBBBBBBBBBUUUUNL',
    '.LBPPBBBBBBBBBBBBBUUUULL',
    '.LBBBBBBBBBBBBBBBBBUUUL.',
    '.LBBBBBBBBBWWWWWWBBBBL..',
    'TLDBBBBBBWWWWWWWWWBBL...',
    'TLDDBBBBWWWWWWWWWWBDL...',
    '.tLDDDBBWWWWWWWWWDDL....',
    '..LLLLLLLLLLLLLLLLL.....',
    '......LWWWL...LWWWL.....',
    '.......LLL.....LLL......',
  ...
  const SLEEP = [
    ...
    '.LBBBBBBBBBBBBBBBPPBBL..',
    'LBBBBBBBBBBBBBBBBPPBBBL.',
    'LBBBBLLBBBBBBBBBBBBBBBL.',
    'LBUUUBBBBBBBBBBBBBBBBBBL',
    'LNUUUBBBBBBBBBBBBBBBBBBL',
    'LBUUUBBBBBBWWWWWWWWBBBBL',
    '.LBBBBBBBWWWWWWWWWWWBBL.',
    '.LDBBBBBWWWWWWWWWWWWBDL.',
    '..LDDBBBWWWWWWWWWWWDDLt.',
    '...LLLDDDDWWWWWWWDDLLTT.',
    '......LLLLLLLLLLLLL..T..',
    '........................',
    '........................',
    '........................',
  ...
  const BELLY = [
    ...
    '....LEEEL....LL....LL...',
    '....LEEEEL..LWWL..LWWL..',
    '...LLBEEBLLLLBBLLLLBBLL.',
    '..LBBBBBBBBBBWWWWWWWWBBL',
    '.LBBBBBBBBBWWWWWWWWWWWBL',
    '.LBBBBYBBBWWWWWWWWWWWWBL',
    'LBUBBYBBBWWWWWWWWWWWWWBL',
    'LNUBBBBBBWWWWWWWWWWWWWBL',
    'LBUBPPBBBBWWWWWWWWWWWBBL',
    '.LBBPPBBBBBWWWWWWWWWBBLt',
    '.LDBBBBBBBBBBBBBBBBBDDLT',
  ...
  const POSES = {
    front: { f: [FRONT, F2(FRONT, { 8: M(['..LBBBBBBBBB'])[0], 9: M(['..LBBBBLBBBB'])[0] })], anim: 'blink', dur: '3.4s' },
    back:  { f: [BACK, F2(BACK, { 1: M(['....LLL.....'])[0], 2: M(['...LBBBL....'])[0], 3: M(['...LBBBBBLLL'])[0] })], anim: 'blink', dur: '2.8s' },
    eat:   { f: [EAT, F2(EAT, { 13: M(['..LBBBBBBUnn'])[0], 14: M(['..LBBBBBLBBn'])[0], 15: M(['...LLBBBLBBB'])[0] })], anim: 'alt', dur: '.5s' },
    ...
    belly: { f: [BELLY, F2(BELLY, { 4: '....LEEEL.....LL....LL..', 5: '....LEEEEL...LWWL..LWWL.' })], anim: 'alt', dur: '.9s' },
  };

  // アクセサリーの置き場所（ポーズごと）: head=頭のてっぺん, brow=おでこ, chin=あご
  const HEAD = {
    front: { head: [12, 3], brow: [12, 7], chin: [12, 15] },
    side:  { head: [10, 6], brow: [17, 9], chin: [20, 16] },
    back:  { head: [12, 3], brow: [12, 6], chin: null },
    sleep: { head: [12, 5], brow: [5, 10], chin: [2, 15] },
    eat:   { head: [12, 3], brow: [12, 7], chin: [12, 15] },
    belly: { head: [6, 6],  brow: [4, 8],  chin: [2, 13] },
  };
  ...
  function hamsterPalette(c, tail) {
    ...
    return {
      ...
      U: c.belly, Y: c.eye, N: c.nose, T: tail ? c.body : null, t: c.belly, n: '#6b4a2a', z: c.line,
    };
  }
